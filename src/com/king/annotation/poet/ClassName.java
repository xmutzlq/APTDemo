...
public final class ClassName extends TypeName implements Comparable<ClassName> {
	...
	private ClassName(List<String> names, List<AnnotationSpec> annotations) {
		...
		this.canonicalName = (names.get(0).isEmpty() ? Util.join(".", names.subList(1, names.size()))
				: Util.join(".", names));
	}
	...
	public ClassName nestedClass(String name) {
		...
		List<String> result = new ArrayList<String>(names.size() + 1);
		result.addAll(names);
		result.add(name);
	 ...
	 * this with package name {@code "java.util"} and simple names {@code "Map"}
