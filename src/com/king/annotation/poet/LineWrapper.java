...
final class LineWrapper {
	...
	/**
	 * The number of characters since the most recent newline. Includes both out
	 * and the buffer.
	 */
	private int column = 0;

	/**
	 * -1 if we have no buffering; otherwise the number of spaces to write after
	 * wrapping.
	 */
	...
	void append(String s) throws IOException {
		...
		if (indentLevel != -1) {
			...
			// If s doesn't cause the current line to cross the limit, buffer it
			// and return. We'll decide
