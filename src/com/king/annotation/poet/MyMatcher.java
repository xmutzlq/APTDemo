...
public final class MyMatcher implements MatchResult {
    ...
    public MatchResult toMatchResult() {
        MyMatcher result = new MyMatcher(this.parentPattern, text.toString());
    ...
    /**
      ...
      * @since 1.5
      */
    public MyMatcher usePattern(MyPattern newPattern) {
        if (newPattern == null)
     ...
     * @return  This matcher
     */
    public MyMatcher reset(CharSequence input) {
        text = input;
        return reset();
    }
     ...
     */
    public MyMatcher appendReplacement(StringBuffer sb, String replacement) {
     ...
     * @since 1.5
     */
    public MyMatcher region(int start, int end) {
     ...
     * @since 1.5
     */
    public MyMatcher useTransparentBounds(boolean b) {
        transparentBounds = b;
        return this;
    }
     ...
     * @since 1.5
     */
    public MyMatcher useAnchoringBounds(boolean b) {
        anchoringBounds = b;
        return this;
    }
